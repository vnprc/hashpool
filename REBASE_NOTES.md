...
| `roles/pool/src/lib/mining_pool/pending_shares.rs` | (removed) legacy pending share cache superseded by message hub context tracking | — | No | Eliminated now that `MintPoolMessageHub` owns pending quote metadata. |
